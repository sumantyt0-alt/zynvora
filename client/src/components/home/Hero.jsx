    ...
    <section className="bg-linear-to-r from-blue-700 via-indigo-700 to-purple-700 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="mt-8 flex bg-white rounded-xl overflow-hidden shadow-lg max-w-xl">
            <input
              type="text"
            ...
            <button className="bg-blue-600 px-6 text-white font-semibold hover:bg-blue-700 transition">
              <FaSearch/>
              Search
            </button>
          </div>
